...
include("admin/model/slider.php");
...
$getSlider = $slider->getActiveSlider();
            ...
            <div class="slider-1">
                <div class="col-sm-12 owl-slider-1">
                    <div class="owl-carousel" data-margin="0" data-loop="yes" data-nav="yes" data-dots="yes" data-items_xs="1" data-items_sm="1" data-items_md="1">
                        ...
                        <?php foreach($getSlider as $key=>$slider): ?>
                        <div class="img-slider-1">
                                <a href="<?php echo $slider['url'] ? $slider['url'] : '#'; ?>"><img src="admin/uploads/mainslider/<?php echo $slider['logo']; ?>" alt=""></a>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
...
<section class="so-spotlight3">
    <div class="container-fluid">
        <div class="col-sm-12 banners">
            <?php foreach($getBanner as $key=>$banner): ?>
                <div class="img-slider-1" style="display: inline;float: left; width: 50%;">
                <?php if($key == 0){?>
                    <a href="<?=$banner['url'] ? $banner['url'] : '#'?>"><img src="admin/uploads/banner/<?php echo $banner['logo']; ?>" alt=""></a>
                <?php } ?>
                </div>



            <div class="banner-right" style="margin-top: -5px; margin-left: 1px; width: 49%;">
                ...
                <div class="banner-right-bottom">
                    <div class="banner-right-bottom-1" style="-362px; clear: both;">
                        <?php if($key == 2){?>
                            <a href="<?=$banner['url'] ? $banner['url'] : '#'?>"><img src="admin/uploads/banner/<?php echo $banner['logo']; ?>" alt=""></a>
                        <?php } ?>
                    </div>
                    <div class="banner-right-bottom-2" style="    margin-top: -327px !important; ">
                        <?php if($key == 3){?>
                            <a href="<?=$banner['url'] ? $banner['url'] : '#'?>"><img src="admin/uploads/banner/<?php echo $banner['logo']; ?>" alt=""></a>
                        <?php } ?>
                    </div>
