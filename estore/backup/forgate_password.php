...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <!-- Basic page needs
    ============================================ -->
    <title>Forgate Password::eStore</title>
							...
							<div class="row">
								...
								<form action="admin/controller/CustomerController.php" method="post" enctype="multipart/form-data">
									<div class="col-sm-6 customer-login">
										...
										<div class="well">
											<h2><i class="fa fa-file-text-o" aria-hidden="true"></i> Forgotten Password</h2>
											<p><strong>I am forgotten my password</strong></p>
										...
										<input type="hidden" name="action" value="customer_forgatepassword_process" required="" readonly="">
